...
namespace Seb.Fluid.Rendering
{
	...
	public class ParticleDisplay3D : MonoBehaviour
	{
		...
		public float scale;
		public Color tint = new Color(0.1f, 0.3f, 0.9f);   // particle paint colour (set by the builder)
		...
		/// <summary>Force a rebind of mesh/material/GPU buffers (call after FluidSim.Reinitialize).</summary>
		public void ForceRebuild()
		{
			modeOld = DisplayMode.None;
			needsUpdate = true;
		}
